...
const getReviewQuiz = async () => {
  ...
  return axios
    ...
    .then((res) => {
      ...
      const { data } = res
      const vocabReviewQuiz: VocabReviewQuizType[] = data.map((item: any) => {
        return {
          ...
          quizAnswerExplain: item.quiz_anwer_explain,
        }
      })

      return vocabReviewQuiz
    })
    .catch((err) => {
