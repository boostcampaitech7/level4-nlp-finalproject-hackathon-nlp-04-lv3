    ...
    <div className="w-full h-auto bg-[var(--color-surface-primary-1)] flex flex-col items-center overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-16 relative">
          ...
          <div className="self-stretch h-auto flex-col justify-start items-center gap-[89px] flex pt-[100px]">
            <div className="h-[152px] flex-col justify-start items-center gap-[53px] flex">
              <div className="self-stretch text-center whitespace-normal"> 
                <span className="display-l text-[var(--color-main)]">아라부기</span>
                <span className="display-l text-[var(--color-text-primary)]">와 함께 <br />더 깊이 이해하고 더 넓게 소통하세요.</span>
              </div>
            </div>
        ...
        />
          ...
          <div className=" h-auto flex-col justify-start items-stretch gap-6 flex">
            <div className="title-m self-stretch h-[55px] text-[var(--color-text-primary)]">📖 OOO님이 관심 있어 할 만한 글이에요!</div>
        ...
        />
              ...
              <div className="bg-[var(--color-surface-primary-2)] rounded-[28px] p-[30px] flex flex-col gap-[26px] h-full">
                <div className="flex items-center gap-2">
                  <span className="text-[var(--color-text-primary)] title-m">고요의 힘</span>
                  <span className="text-[var(--color-text-intermediate)] body-m">틱낫한</span>
                </div>
                <div className="flex flex-col justify-between h-full">
                  <div className="text-neutral-600 body-m mb-6">우리의 머릿속은 늘 생각으로 가득 차다. 그래서 다른 사람들의 이야기를 들을 공간조차 없다. 우리가 타인과 더 많이 연결되고자 한다면 그들의 이야기를 경청해야 한다. 진심으로 귀 기울여 듣는다는 것은 이해하는 것이고, 그것을 위해서는 우리가 "내면의 NSTNon-Stop Thinking 라디오"를 꺼야 한다고 조언하고다. 독자들은 이 책을 통해 틱낫한 스님이 설명하는 내면의 고독과 마음챙김의 가장 근원적 해법인 일상 수행의 다양하고 쉬운 방법을 직접 체험할 수 있을 것이다.</div>
                  <div className="flex justify-end items-center gap-3">
                  <Button
          size="small"
          color="purple"
        ...
        />
          ...
          >
            <div className="grow shrink basis-0 text-center md:text-left flex flex-col gap-2">
              <span className="animated-text block text-[var(--color-text-primary)] display-m">나에게 맞는</span>
              <span className="animated-text block text-[var(--color-main)] display-m">매일 새로운</span>
              <span className="animated-text block text-[var(--color-text-primary)] display-m">맞춤 학습</span>
            </div>
          ...
          >
            <div className="grow shrink basis-0 text-right flex flex-col gap-2">
              ...
              <span className="animated-text block text-[var(--color-text-primary)] display-m">친절하게 풀어드립니다</span>
            </div>
          </TextAnimationWrapper> 
          </div>
        </div>
      ...
      <div className="w-full py-[23px] bg-[var(--color-button-inverse)] justify-center items-center gap-2.5 inline-flex">
        <div className="grow shrink basis-0 flex-col justify-center items-center gap-2.5 inline-flex">
          ...
          <div className="self-stretch text-center text-[var(--color-text-inverse)] body-m">GitHub: https://shorturl.at/XIlUM</div>
          <div className="self-stretch text-center text-[var(--color-text-inverse)] body-m">2024.08-2025.02</div>
        </div>
      </div>
    </div>
  );
