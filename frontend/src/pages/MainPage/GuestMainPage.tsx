...
export const GuestMainPage: React.FC = () => {
  ...
  return (
    <div className="w-full h-auto bg-surface-primary-1 flex flex-col items-center overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-16 relative">
        ...
        <div className="flex-col justify-start items-center gap-[150px] flex relative z-10">
          ...
          <div className=" h-auto flex-col justify-start items-stretch gap-6 flex">
            <div className="title-m self-stretch h-[55px] text-text-primary">
              📖 OOO님이 관심 있어할 만한 글이에요!
            </div>
            <div className="self-stretch p-2.5 grid grid-cols-1 md:grid-cols-2 gap-[60px]">
              <div className="bg-surface-primary-2 rounded-[28px] p-[30px] flex flex-col gap-[26px] h-full">
